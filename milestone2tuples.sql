...
INSERT INTO StreamSongCertification
...
INSERT INTO
    Song
    (SongID, Genre,Duration,Lyrics,NumStreams)
VALUES
    (song_seq.nextval, 'Pop', 3, 'Fly', 10000000);

INSERT INTO
    Song
    (SongID, Genre,Duration,Lyrics,NumStreams)
VALUES
    (song_seq.nextval, 'Rap', 6, 'Never', 2000000);

INSERT INTO Song
    (SongID, Genre,Duration,Lyrics,NumStreams)
VALUES
    (song_seq.nextval, 'Monkey-Trap', 4, 'Auuuugh', 500000);

INSERT INTO Song
    (SongID, Genre,Duration,Lyrics,NumStreams)
VALUES
    (song_seq.nextval, 'Jazz', 1, 'NAAAAAAAAAAAAAH', 1000000);

INSERT INTO Song
    (SongID, Genre,Duration,Lyrics,NumStreams)
VALUES
    (song_seq.nextval, 'Country', 5, 'Country', 100000);
...
INSERT INTO PlaylistContentIncludesSong
    (ContentID, SongID)
VALUES
    (0, 0);
INSERT INTO PlaylistContentIncludesSong
...
INSERT INTO StreamAlbumCertification
    (NumStreams, Certification)
VALUES
    (10000000, 'Diamond');
INSERT INTO StreamAlbumCertification
...
INSERT INTO TitleRelease
    (Title, AlbumVersion, ReleaseDate, NumSongs)
VALUES
